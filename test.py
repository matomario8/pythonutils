...
class TestApp(TestCase):
    ...
    def test_date_parsing(self):
        ...
        string1b = "10:30 A.M., Thursday, 11/7/19"
        self.assertEqual(parse_date(string1a), "2019:11:07")
        self.assertEqual(parse_date(string1b), "2019:11:07")

        # Test day missing
        string2a = "10:30 A.M., Thursday, May, 2019"
        # string2b = "10:30 A.M., Thursday, 5/19"  # OPTIONAL
        self.assertEqual(parse_date(string2a), "2019:05:01")
        # self.assertEqual(parse_date(string2b), "2019:05:01")  # OPTIONAL

        # Test month + day missing
        string3 = "10:30 A.M., Thursday, 2019"
        self.assertEqual(parse_date(string3), "2019:01:01")

        # Test that no date returns blank
        string4 = "10:30 A.M., Thursday"
        self.assertEqual(parse_date(string4), "")
